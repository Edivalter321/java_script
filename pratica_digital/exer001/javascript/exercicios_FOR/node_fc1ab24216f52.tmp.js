...
/* Questao 01 (Crie um loop que conta de 1 a 10 e imprima cada número no console.)
for (let i = 1; i <= 10; i++) {
  console.log(i)
}
*/
// Contagem regressiva
// Questão 02 (Crie um loop que conta de 10 a 1 e imprima cada número no console
